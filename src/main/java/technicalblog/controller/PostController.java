...
public class PostController {
    ...
    public String createPost(Post newPost, HttpSession session) {
        ...
        if (newPost.getFamily()!= null){
            Category familyCategory = new Category();
            familyCategory.setCategory(newPost.getFamily());
            newPost.getCategories().add(familyCategory);
        }

        if (newPost.getFriends()!= null){
            Category friendCategory = new Category();
            friendCategory.setCategory(newPost.getFriends());
            newPost.getCategories().add(friendCategory);
        }
